    ...
    card.innerHTML = `
        ...
        <div class="book-info">
          ...
          <div class="book-actions">
            <!-- Nút Xem (Mở tab thẻ link URL lấy file thẳng từ DB) -->
            <button class="btn-view" onclick="window.open('${fileUrl}', '_blank'); event.stopPropagation();"><i class="fas fa-eye"></i> Xem</button>
